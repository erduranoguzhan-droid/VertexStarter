...
const tr = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Verilerim KVKK ve GDPR'a uygun işleniyor mu?", a: "Evet. Verilerinizi yalnızca izinli, şifreli ve denetlenebilir akışlarda işleriz; talep halinde silme ve dışa aktarma sağlarız." },
      { q: "Hangi araçlarla entegre oluyorsunuz?", a: "n8n, Make, Zapier, HubSpot, Salesforce, Shopify, WhatsApp, Slack, OpenAI, Claude ve 100+ araçla native entegrasyon kurarız." },
      { q: "AI çalışan hata yaparsa ne oluyor?", a: "Sistemleri kurallar ve güven eşikleriyle kurarız; emin olmadığı durumlarda konuşmayı bir insana devreder. Sürekli izler ve iyileştiririz." },
      { q: "AI çalışanlar hangi dilleri destekliyor?", a: "Başta Türkçe ve İngilizce olmak üzere onlarca dilde çalışır; çok dilli müşteri kitlenizi aynı sistemle yönetebilirsiniz." },
      { q: "WhatsApp entegrasyonu resmi mi?", a: "Evet, resmi WhatsApp Business API üzerinden kurarız; hesabınız güvende kalır ve mesajlaşma politikalarına uygun çalışır." },
      { q: "Sesli AI asistan gerçek telefon hattında çalışır mı?", a: "Evet. Gelen çağrıları karşılar, bilgi verir, randevu oluşturur ve gerektiğinde ekibinize aktarır." },
      { q: "Mevcut CRM'imi değiştirmem gerekir mi?", a: "Hayır. Mevcut CRM ve araçlarınızın üzerine akıllı bir katman kurarız; yığınınızı bozmadan ilerleriz." },
      { q: "Kurulum sonrası bakım sağlıyor musunuz?", a: "Evet. İşletim paketlerinde sürekli izleme, bakım, güncelleme ve aylık optimizasyon yer alır." },
      { q: "Sistemi kendi ekibimize devredebilir miyiz?", a: "Evet. Ekibinizi eğitir, dokümantasyon sağlar ve dilerseniz yönetimi tamamen size devrederiz." },
      { q: "Ne kadar sürede geri dönüş (ROI) görürüm?", a: "Çoğu müşteri ilk birkaç ay içinde zaman tasarrufu ve dönüşüm artışıyla geri dönüşü görmeye başlar. Hedefleri baştan KPI'larla netleştiririz." },
      { q: "Küçük bir işletme için de uygun mu?", a: "Evet. Starter paketi tek bir AI çalışanla başlamak isteyen küçük işletmeler için tasarlandı; büyüdükçe ölçeklenir." },
      { q: "Özel bir AI ajanı geliştirebilir misiniz?", a: "Evet. Enterprise kapsamında size özel ajanlar, modeller ve entegrasyonlar geliştiririz." },
      { q: "İçeriği ve bilgi tabanını kim sağlıyor?", a: "Ürün ve süreç bilginizi birlikte toplarız; SSS, dokümanlar ve geçmiş yazışmalardan AI'ın bilgi tabanını kurarız." },
      { q: "Sistem yoğun talepte ölçeklenir mi?", a: "Evet. AI çalışanlar aynı anda binlerce konuşmayı yönetebilir; yük arttıkça ek maliyet olmadan ölçeklenir." },
      { q: "Raporlama ve görünürlük nasıl sağlanıyor?", a: "Canlı panolarla her konuşmayı, dönüşümü ve otomasyon adımını gerçek zamanlı izlersiniz." },
      { q: "Birden fazla AI çalışan birlikte çalışır mı?", a: "Evet. Destek, satış ve randevu ajanları aynı sistemde bağlı çalışır; müşteri tek ve tutarlı bir deneyim yaşar." },
      { q: "Nereden başlıyoruz?", a: "Ücretsiz keşif görüşmesiyle. Hedeflerinizi dinler, hızlı kazanımları çıkarır ve size özel bir yol haritası sunarız." },
    ],
  },
  contact: {
    eyebrow: "İLETİŞİM",
...
const en: Dict = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Is my data processed in line with GDPR and KVKK?", a: "Yes. We process your data only in permitted, encrypted and auditable flows, with deletion and export on request." },
      { q: "Which tools do you integrate with?", a: "We build native integrations with n8n, Make, Zapier, HubSpot, Salesforce, Shopify, WhatsApp, Slack, OpenAI, Claude and 100+ tools." },
      { q: "What happens if an AI employee makes a mistake?", a: "We build systems with rules and confidence thresholds; when unsure it hands the conversation to a human. We monitor and improve continuously." },
      { q: "Which languages do the AI employees support?", a: "They work in dozens of languages, primarily Turkish and English, so you can serve a multilingual audience from one system." },
      { q: "Is the WhatsApp integration official?", a: "Yes, we build on the official WhatsApp Business API; your account stays safe and compliant with messaging policies." },
      { q: "Does the AI voice assistant work on a real phone line?", a: "Yes. It answers incoming calls, shares information, books appointments and hands off to your team when needed." },
      { q: "Do I need to replace my current CRM?", a: "No. We add a smart layer on top of your current CRM and tools, without breaking your stack." },
      { q: "Do you provide maintenance after setup?", a: "Yes. Operation packages include continuous monitoring, maintenance, updates and monthly optimization." },
      { q: "Can we take over the system ourselves?", a: "Yes. We train your team, provide documentation and can fully hand over management if you wish." },
      { q: "How soon will I see ROI?", a: "Most clients start seeing returns within the first few months through time savings and higher conversion. We define goals with KPIs upfront." },
      { q: "Is it suitable for a small business?", a: "Yes. The Starter package is designed for small businesses starting with a single AI employee and scales as you grow." },
      { q: "Can you build a custom AI agent?", a: "Yes. Under Enterprise we build custom agents, models and integrations tailored to you." },
      { q: "Who provides the content and knowledge base?", a: "We gather your product and process knowledge together and build the AI's knowledge base from FAQs, docs and past conversations." },
      { q: "Does the system scale under heavy demand?", a: "Yes. AI employees can handle thousands of conversations at once and scale with load at no extra cost." },
      { q: "How is reporting and visibility provided?", a: "With live dashboards you track every conversation, conversion and automation step in real time." },
      { q: "Do multiple AI employees work together?", a: "Yes. Support, sales and appointment agents work connected in one system, so the customer gets a single, consistent experience." },
      { q: "Where do we start?", a: "With a free discovery call. We listen to your goals, surface quick wins and deliver a custom roadmap." },
    ],
  },
  contact: {
    eyebrow: "CONTACT",
